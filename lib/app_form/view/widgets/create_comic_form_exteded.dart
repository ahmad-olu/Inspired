...
Future<bool?> showExtendedComicForm(
  ...
  return showDialog(
    ...
    builder: (dialogContext) => BlocProvider.value(
      value: BlocProvider.of<CreateImageBookFormCubit>(context),
      child: BlocBuilder<CreateImageBookFormCubit, CreateImageBookFormState>(
